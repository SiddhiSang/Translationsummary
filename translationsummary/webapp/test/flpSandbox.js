		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#compresalescentraltranslationsummary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compresalescentraltranslationsummary-display": {
								"semanticObject": "compresalescentraltranslationsummary",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.presalescentral.translationsummary",
									"url": sap.ui.require.toUrl("com/presalescentral/translationsummary")
								}
							}
						}
					}
